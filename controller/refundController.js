...
exports.createRefund = async (req, res) => {
  const { account, account_name, bank_name, refund_reason, pt_number } =
    req.body;
  ...
  try {
    ...
    const refundResult = await database.query(
      'INSERT INTO user_refund (account, account_name, bank_name,pt_number) VALUES ($1, $2, $3,$4) RETURNING refund_number',
      [account, account_name, bank_name, pt_number]
    );
